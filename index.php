...
<div class="hero">
	...
	<h1>GANA DINERO RÁPIDO Y FÁCIL </h1>
    <p>Sin experiencia profesional ni estudios previos</p>
    <div class="centrarBotones">
    <button type="button" class="btn work naranja"><a href="cachuelos.php">TRABAJAR</a></button>
    <button type="button" class="btn amarillo-outline" ><a href="contratar.php">CONTRATAR</a></button>
    </div>
	</div>
	</div>
...
window.onscroll = function (){
    ...
    if(scroll >100){
         ...
         nav.className = "navbar navbar-expand-lg navbar-light fixed-top dark";
    } else if(scroll<200){
      var nav = document.getElementById("nav");
